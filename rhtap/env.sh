...
export IMAGE_URL=${IMAGE_URL-rhtap-quay-quay-rhtap-quay.apps.rosa.kx-4e698538c0.t3a5.p3.openshiftapps.com/rhtap/rhtap-qe:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/irbxe0hpt-java-springboot-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.rosa.kx-4e698538c0.t3a5.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.rosa.kx-4e698538c0.t3a5.p3.openshiftapps.com}
